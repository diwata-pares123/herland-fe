    ...
    <MobileContainer>
      <div className="bg-white relative size-full flex flex-col" data-name="Two Step Verification">
        ...
        <div className="flex-1 flex flex-col items-center px-6 pt-20">
          ...
          <p className="font-['Open_Sans:Regular',sans-serif] font-normal text-[#989898] text-[14px] text-center leading-[24px] max-w-[340px] mb-8" style={{ fontVariationSettings: "'wdth' 100" }}>
            Enter the six digit code generated by your authentication app.
          </p>

          {/* Error Message Display */}
          {errorMsg && (
            <div className="mb-4 text-red-500 font-['Poppins:Medium',sans-serif] text-[13px] text-center">
              {errorMsg}
            </div>
          )}
          ...
          <div className="flex gap-[10px] justify-center w-full mb-12">
            {codes.map((code, index) => (
              <div key={index} className={`rounded-[10px] size-[50px] border ${errorMsg ? 'border-red-500' : 'border-[#e1e1e1]'} flex items-center justify-center`}>
                <input
          ...
          <div className="w-full max-w-[371px]">
            <button
              ...
              disabled={isLoading}
              className={`bg-gradient-to-r from-[#20a9ea] h-[44px] rounded-[100px] to-[#006c9f] via-[#118cc6] via-[62.019%] w-full border-none flex items-center justify-center ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
            >
