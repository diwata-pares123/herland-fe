...
export function AdminLoginPage() {
  ...
  // Pinalitan ng email para mag-match sa backend
  ...
  return (
    ...
    <MobileContainer>
      ...
      >
        ...
        <div className="mt-[60px] flex flex-col font-['Poppins:SemiBold',sans-serif] h-[43px] justify-center leading-[0] not-italic text-[#184e8d] text-[32px] text-center tracking-[1.6px] w-[293px]">
        ...
        <div className="w-full max-w-[352px] px-4 mt-[20px]">
          ...
          <button
            ...
            className={`relative bg-gradient-to-r from-[#20a9ea] h-[47px] rounded-[30px] to-[#006c9f] via-[#118cc6] via-[69.712%] w-full flex items-center justify-center border-none ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}

          >

            <p className="font-['Poppins:SemiBold',sans-serif] text-[16px] text-white tracking-[0.8px] leading-[50px]">

              {isLoading ? "Logging in..." : "Log in as Administrator"}
